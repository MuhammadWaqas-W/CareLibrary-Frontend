...
const CompletedShifts = () => {
  ...
  <Card className='shifts-details-completed-shift border-radius-10'>
    ...
    >
  <Form.Item name="gender" label={<span className='fs-14 fw-600 line-height-17 title-color'>Sign off Status</span>}>
  <Select className='completed-shift-select-input border-radius-4'
   ...
   <Row gutter={[23,23]} className="wrap-main-completed-shift">
     {completedShiftData.map((shiftData:any,id)=>{
       return(    
         <Col xxl={24} xl={24} lg={24} md={24} sm={24} xs={24} key={id} className="gutter-row  ">
           ...
           <Col xxl={6} xl={6} lg={8} md={24} sm={24} xs={24} className="shift-details-cancel-left-content"> 
             <div  className='d-flex align-center cancel-shift-img-text'>
                ...
                <Row gutter={[18,18]} className=' d-flex  align-center shift-cancel-card-content' >
                  ...
                  <Col xl={10}>  <span className='fw-400 fs-14 line-height-22 title-color text-left'>{shiftData.weather}</span></Col>
                   </Row> 
                   <Row gutter={[18,18]}  className=' d-flex align-center shift-cancel-card-content'>
                   <Col xl={3}>  <img src={shiftData.dateImg} alt="HomeIcon" width={21} height={21}/></Col>
                   <Col xl={20}>  <span  className='fw-400 fs-14 line-height-22 title-color'>{shiftData.date}</span></Col>
                   </Row>
                   <Row gutter={[18,18]}  className=' d-flex  align-center shift-cancel-card-content'>
                   <Col xl={3}>   <img src={shiftData.shiftRateImg} alt="HomeIcon" width={16} height={16}/></Col>
                   <Col xl={18}>   <span  className='fw-400 fs-14 line-height-22 title-color' dangerouslySetInnerHTML={{ __html: shiftData?.rate }}>
                     </span>
                     </Col>
                     </Row>
                     <Row gutter={[18,18]}  className=' d-flex  align-center shift-cancel-card-content'>
                     <Col xl={3}>   <img src={shiftData.departmentImg} alt="HomeIcon" width={16} height={16} className="" style={{borderRadius:"50%",border:"1.5px solid #65CDF0"}}/></Col>
                     <Col xl={18}>   <span  className='fw-400 fs-14 line-height-22 title-color' dangerouslySetInnerHTML={{ __html: shiftData?.department }}>
                     </span>
                     </Col>
                     </Row> 
                   </div>
             ...
             <span className='shift-line'> <Divider type="vertical" className='verical-line' style={{height:"250px",border:"1px solid  #D9DBE9",marginLeft:"0px"}}/></span> 
             <Col xxl={18} xl={18} lg={15} md={24} sm={24}  xs={24}>
              ...
              <p className='fw-500 fs-16 line-height-24 title-color ' style={{paddingBottom:"4px",marginTop:"0px"}}>  Shift Calculation</p>
                <Row gutter={[8,8]} style={{paddingBottom:"12px"}}>  
                 ...
                 <Col xl={4} >
                 <span className='fw-600 fs-14 line-height-17 title-color'   dangerouslySetInnerHTML={{ __html: shiftData?.totalShiftHours }}>
                 </span>
                 
                 </Col>
              {/* <Col xl={1}><Divider type="vertical" className='verical-line' style={{height:"20px",border:"1px solid  #D9DBE9",marginLeft:"20px"}}/></Col> */}
                 <Col xl={4}>
                 <span className='fw-400 fs-14 line-height-22 title-color '>
                  Shift Rate
                 </span>
                 ...
                 <Col xl={3}>
                 <span className='fw-600 fs-14 line-height-17 title-color' dangerouslySetInnerHTML={{ __html: shiftData?.shiftRate }}>
                 </span>
                 </Col>
                 <Col xl={3}>
                 <span className='fw-400 fs-14 line-height-22 title-color '>
                 ...
                 <Col xl={2}>
                 <span className='fw-600 fs-14 line-height-17 title-color' dangerouslySetInnerHTML={{ __html: shiftData?.shiftType }}>
                 </span>
                 </Col>
                 ...
                 <Col xl={2}>
                 <span className='fw-600 fs-14 line-height-17 title-color' dangerouslySetInnerHTML={{ __html: shiftData?.endShiftRate }}>
                 </span>
                 </Col>
                ...
                <Col xl={3}>
                 ...
                 <Col xl={4} >
                 <span className='fw-600 fs-14 line-height-17 title-color'   dangerouslySetInnerHTML={{ __html: shiftData?.shiftTime }}>
                 </span>
                 </Col>
                 ...
                 <Col xl={3} >
                 <span className='fw-600 fs-14 line-height-17 title-color'   dangerouslySetInnerHTML={{ __html: shiftData?.totalShiftAmount }}>
                 </span>
                 </Col>
                ...
                Extra Hours Worked:
                 ...
                 <Col xl={2} >
                 <span className='fw-600 fs-14 line-height-17 title-color'   dangerouslySetInnerHTML={{ __html: shiftData?.extraHoursWorked }}>
                 </span>
                 </Col>
