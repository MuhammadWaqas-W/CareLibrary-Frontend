...
const Reports = () => {
    ...
    return (
        <div className='finance-reports-wrapper'>
            <p className='title-color fs-14 fw-400 line-height-22'>Please click on each of the follwing boxes to see a full report. If you need only any other report, please let us know so we can make them available for you.</p>
