        ...
        <div className='client-manager-information-form-wrapper decleration-form-styles'>
            ...
            <div className='grey-scale-body'>
                ...
                <div className="form-check-group">
                    <Switch onChange={onChange} /> &nbsp; <span> I agree to the above Declaration.</span>
                </div>
            </div>
            ...
            <div style={{ marginTop: '20px' }}>
                ...
                <div className="form-check-group">
                    <Switch onChange={onChange} /> &nbsp; <span className="grey-scale-body"> I agree to the above Declaration.</span>
                </div>
            </div>
