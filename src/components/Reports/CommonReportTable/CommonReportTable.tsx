...
const CommonReportTable = (props: any) => {
    ...
    return (
        <div className='common-report-table-wrapper'>
            ...
            <Table tableLayout="fixed" columns={tableHeader} dataSource={tableData} pagination={pagination} onChange={(pagination: any) => setPagination(pagination)} className="common-report-table" scroll={{ x: "max-content", scrollToFirstRowOnChange: true }} />
        </div>
    )
}
