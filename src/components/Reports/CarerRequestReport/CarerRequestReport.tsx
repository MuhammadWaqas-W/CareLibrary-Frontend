...
import {
  CarerRequestReportFilters,
  CarerRequestReportMockData,
} from "../../../mock/ReportMockData/CarerRequestReportMockData";
  ...
  const CarerRequestReportTableHeader: ColumnsType<carerRequestReportMockDataInterface> =
    [
      ...
      },
      {
        ...
        key: "requestedByName",
        align: "center",
        render: (_, { requestedByImg, requestedByName }: any) => (
          <div
            style={{ marginLeft: "auto", textAlign: "center", width: "80%" }}
          >
          ...
          <span
            className={`${
              status === "Approved"
                ...
                ? "secondary-color"
                : "error-color"
            }   fs-14 fw-400 m-0 line-height-22 `}
          >
            {status}
          </span>
        ),
  ...
  return (
    <div className="reports-child-wrapper-class">
      <Row>
        ...
        <Col xs={24}>
          <CommonReportTable
            tableHeader={CarerRequestReportTableHeader}
            tableData={CarerRequestReportMockData}
          />
        </Col>
      </Row>
      ...
      >
        <p
          className="fs-16 fw-400 form-heading-color line-height-32 m-0"
          style={{ paddingBottom: "1.063rem" }}
        >
          Requests
        </p>
        <Space size={25} wrap className="name-email-wrapper">
          <img
            src={openDetailsModal?.requestedByImg}
            alt="user"
            width={94}
            height={94}
          />
          <div className="name-wrapper">
            <h2 className="fs-16 fw-500 line-height-24 title-color m-0">
              {openDetailsModal?.requestedByName}
            </h2>
            <p className="fs-14 fw-400 line-height-22 light-grey-color m-0">
              {openDetailsModal?.careHome}
            </p>
          </div>
          <div className="email-wrapper">
            <p className="fs-14 fw-400 line-height-22 title-color m-0">
              mr.vaqas@gmail.com
            </p>
            <p className="fs-14 fw-400 line-height-22 title-color m-0">
              41 333 222 1100
