...
import { GrossProfitLossReportFilters, GrossProfitLossReportMockData } from '../../../mock/ReportMockData/GrossProfitLossReport';
    ...
    return (
        <div className='reports-child-wrapper-class'>
            <Row gutter={[0, 20]}>
                ...
                <Col xs={24}>
                    <CommonReportTable tableHeader={GrossProfileLossReportTableHeader} tableData={GrossProfitLossReportMockData} />
                </Col>
            </Row>
        </div>
    )
