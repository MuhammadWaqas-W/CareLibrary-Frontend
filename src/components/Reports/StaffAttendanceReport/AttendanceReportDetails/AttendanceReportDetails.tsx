...
const AttendanceReportDetailsTableHeader: ColumnsType<attendanceReportDetailsMockDataInterface> = [
    ...
    },
    {
        ...
        align: "center",
        render: (day: string) =>
            <span className='fs-14 fw-400 m-0 line-height-22 title-color'>{day}</span>,
    },
    {
        title: 'Time',
        dataIndex: 'time',
        ...
        align: "center",
        render: (time: string) =>
            <span className='fs-14 fw-400 m-0 line-height-22 title-color'>{time}</span>,
    },
    {
        title: 'Check In/Out',
...
const AttendanceReportDetails = () => {
    ...
    return (
        <Row gutter={[40, 20]} className="attendance-report-details-wrapper">
            ...
            <Col xs={24}>
                <Table tableLayout="fixed" columns={AttendanceReportDetailsTableHeader} dataSource={AttendanceReportDetailsMockData} pagination={false} className="attendance-report-details-table-wrapper" scroll={{ x: "max-content", scrollToFirstRowOnChange: true }} />
            </Col>
        </Row >
    )
}
