...
const CommonReportChildFilters = (props: any) => {
    const { filtersArray, rightCards, extraCards, extraCardsData } = props;



    const handleCommonFilterChange = (value: keyof typeof filtersArray) => {
        console.log("Common Filter Option Value ===============> ", value);
    }
