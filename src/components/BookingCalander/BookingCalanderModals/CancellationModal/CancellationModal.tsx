...
function CancellationModal(props:any) {
  const {isCancellationModalOpen, setIsCancellationModalOpen} = props
  ...
  return (
    <Modal
      ...
      onOk={() => {setIsCancellationModalOpen(false)}}
      onCancel={() => {setIsCancellationModalOpen(false)}}>
        <Form 
            ...
            <Row>
                ...
                <Button type="primary" className="cancel-btn  fs-14 fw-600" htmlType="submit" >Cancel Shift</Button>
                </Col>
            </Row>
        </Form>
    </Modal>
