  ...
  return (
    ...
    >
      ...
      <Space direction="vertical">
        ...
        <Form.Item name="right-to-work" label={<Space size={3} className='fw-600 fs-14'> <div className="onboarding-small-dots"></div>  <span className="title-color">Does your candidate have right to work in Uk?</span> </Space>} >
        ...
        <Form.Item name="dba-check" label={<Space size={3} className='fw-600 fs-14'> <div className="onboarding-small-dots"></div> <span className="title-color">Are you willing to undergo a full enhanced DBA check at a price of $55 ?</span></Space>} >
          <Radio.Group>
            <Radio value="Yes">Yes</Radio>
            <Radio value="No">No</Radio>
          </Radio.Group>
