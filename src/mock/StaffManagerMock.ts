...
export const completedShiftData = [
  {
    ...
    signOff: {
      ...
      signOffByDate: "date",
      modificationsReason:
        "The shift timings were modified as the carer arived later to the care home, than the time that was mentioned n the  timesheet",
    },
  },
];
...
export const renderStaffCompletedImg: any = {
  // title: ProfileImg,
...
export const renderStaffOff: any = {
  signedOffBy: "Signed-off by:",
  modifiedBy: "Modified By:",
};

export const renderStaffCalculation: any = {
  startShiftHours: "Start Shift Hours",
  startShiftRate: "Start Shift Rate",
  endShiftHours: "End Shift Hours",
  endShiftRate: "End Shift Rate",
...
export const StaffCompletedShiftData = [
  {
    id: "1",
    personName: "David Khan ( HCA )",
    weather: "Longday",
    time: "May 18, Tue - 8:00 PM  TO  4:00 AM",
    shiftRate: "Shift Rate:£275.00",
    timer: "Extra Hours Worked: 0 Hrs",
    department:'Old Age Care',
    shiftCalculation: [
      {
        id: "01",
        startShiftHours: "04:00",
        startShiftRate: "£27.00",
        endShiftHours: "04:00",
        endShiftRate: "£25.00",
        shiftTime: "Sun, 03 Apr 22,",
