...
const BirthDayModal = ({ isModalOpen, setIsOpenModal, birthDayMessage, wishButtonText, backgroundColor,iconImage }: any) => {
    ...
    return (
        ...
        <Modal footer={null} centered onCancel={handleDelete} width={499} style={{ textAlign: "center" }} onOk={handleDelete} open={isModalOpen}>
            ...
            <Button type="primary"  onClick={handleDelete}> <span style={{ color: "#FFFFFF" ,marginBottom:"35px"}}>{wishButtonText}</span></Button>
        </Modal>
